...
#define CONFIG_DEFAULT_PUMP_GPIO "16"
#define CONFIG_DEFAULT_PUMP_ACTIVE_LEVEL "1"
#define CONFIG_DEFAULT_PUMP_TIMEOUT_MS "1500"
#define CONFIG_DEFAULT_WEB_CONTROL_ENABLED "0"
#define CONFIG_DEFAULT_LIDAR_WIFI_BRIDGE_ENABLED "1"
...
//-----------------------------ROS2节点相关配置-------------------------------------------
#define CONFIG_DEFAULT_ROS2_NODE_NAME "xuege_motion_control"
...
/*========================================配置名称=======================================*/
#define CONFIG_NAME_NAMESPACE "xuegebot"
...
#define CONFIG_NAME_MOTOR_TARGET_EPSILON "motor_target_eps"
#define CONFIG_NAME_MOTOR0_COMPENSATION_GAIN "motor0_gain"
#define CONFIG_NAME_MOTOR1_COMPENSATION_GAIN "motor1_gain"
#define CONFIG_NAME_MOTOR0_MIN_PWM "motor0_min_pwm"
#define CONFIG_NAME_MOTOR1_MIN_PWM "motor1_min_pwm"
#define CONFIG_NAME_MOTOR0_STARTUP_BOOST_PWM "motor0_start_boost_pwm"
#define CONFIG_NAME_MOTOR1_STARTUP_BOOST_PWM "motor1_start_boost_pwm"
#define CONFIG_NAME_MOTOR0_STARTUP_BOOST_MS "motor0_start_boost_ms"
#define CONFIG_NAME_MOTOR1_STARTUP_BOOST_MS "motor1_start_boost_ms"
...
#define CONFIG_NAME_PUMP_ACTIVE_LEVEL "pump_active_level"
#define CONFIG_NAME_PUMP_TIMEOUT_MS "pump_timeout_ms"
#define CONFIG_NAME_WEB_CONTROL_ENABLED "web_control_enabled"
#define CONFIG_NAME_LIDAR_WIFI_BRIDGE_ENABLED "lidar_wifi_bridge_enabled"
...
public:
    ...
    bool web_control_enabled();
    bool lidar_wifi_bridge_enabled();

    int8_t loop_config_uart(int c, char result[][32]);
    int8_t split_str(const char *line, char result[][32]);

    LeapBotConfig(/* args */) = default;
    ~LeapBotConfig() = default;
};
